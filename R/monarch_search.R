...
#' It returns nodes (no edges) from the Monarch KG, fetched via an instance of
#' `monarch_engine()`.
#'
#' @param query Search query string, e.g. "Cystic fibrosis"
#' @param category A set of node category labels to limit the search to, e.g.
#'                 c("biolink:Disease", "biolink:Gene")
